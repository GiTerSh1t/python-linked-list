...
class turnamenCatur:
    ...
    def cetak_daftar_peserta(self):
        ...
        if current_peserta is None:
            ...
            while current_peserta is not None:
                print("Nama peserta: {}, Peringkat peserta: {}".format(current_peserta.nama, current_peserta.peringkat))
                current_peserta = current_peserta.next
...
while True:
    ...
    if pilihan == "1":
        ...
        print("Peserta telah terdaftar!")

    elif pilihan == "2":
        nama = input("Masukkan nama peserta yang kalah: ")
        turnamen.hapus_peserta(nama)
        print("Peserta telah dihapus!")

    elif pilihan == "3":
        turnamen.cetak_daftar_peserta()

    elif pilihan == "4":
        print("Terima kasih telah mengikuti Turnamen!.")
        break
