...
class Pengunjung:
    ...
    def cetak_buku_dipinjam(self):
        if self.buku is None:
            print("{} Anda belum meminjam buku apapun!.".format(self.nama))
        else:
            print("{} Anda telah meminjam buku berikut:".format(self.nama))
            buku_sekarang = self.buku
...
while True:
    print("\nMenu:")
    print("1. Catatan peminjaman buku")
    ...
    if pilihan == "1":
        ...
        print("Peminjaman buku telah dicata!.")
        ...
        print("Terima kasih sudah meminjam/mengembalikan buku!.")
        break
